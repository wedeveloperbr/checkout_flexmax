...
export default function Pagamento({ data, onUpdate, checkoutData }: PagamentoProps) {
  // usa valor padrão para evitar undefined
  ...
  const [cardData, setCardData] = useState({
    ...
    cvc: data?.dados?.cvc ?? "",
    parcelas: data?.dados?.parcelas ?? "12x de R$ 10,00",
  })
  ...
  const handlePaymentSubmit = () => {
    if (typeof window !== "undefined") {
      localStorage.setItem(
        ...
        JSON.stringify({
          ...checkoutData,
          pagamento: { tipo: selectedPayment, dados: cardData },
        })
      )
    }
  }
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          border:
            selectedPayment === "cartao" ? "2px solid #41DA69" : "1px solid #191F2D1A",
          cursor: "pointer",
        }}
      ...
      <div
        ...
        style={{
          border:
            selectedPayment === "pix" ? "2px solid #41DA69" : "1px solid #191F2D1A",
          cursor: "pointer",
        }}
      ...
      <div
        ...
        style={{
          border:
            selectedPayment === "boleto" ? "2px solid #41DA69" : "1px solid #191F2D1A",
          cursor: "pointer",
        }}
      ...
      {selectedPayment && (
        <Link href={`/checkout/sucessboleto`}>
          <button
